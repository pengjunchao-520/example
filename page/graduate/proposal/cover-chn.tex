...
\newgeometry{top=2.5cm,bottom=2.5cm} %yulins! \restoregeometry

\begin{center}
    \zihao{-4} \songti
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \underline{~~~TP277~~~ } &%{按中国图书分类法，学位办网上可查}  &
        单位代码：         & \uline{\hfill 10335 \hfill} \\
        密{\quad}级：      & \underline{~~~~公开~~~~ } &
        学{\quad\quad}号： & \underline{\StudentID}%{\multido{}{4}{\quad}}
    \end{tabularx}
\end{center}
\vspace{-20pt}
...
\restoregeometry %yulins! \restoregeometry